<?php
/**
 * File for HslOnnelaWsdlClass to communicate with SOAP service
 * @package HslOnnela
 ...
 */
/**
 * HslOnnelaWsdlClass to communicate with SOAP service
 * 
 * @package HslOnnela
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-01-27
 */
class HslOnnelaWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://omatlahdot.hkl.fi/interfaces/kamo?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses HslOnnelaWsdlClass::setLastError()
     * @uses HslOnnelaWsdlClass::initSoapClient()
     * @uses HslOnnelaWsdlClass::initInternArrayToIterate()
     * @uses HslOnnelaWsdlClass::_set()
     ...
     * @return HslOnnelaWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'HslOnnelaWsdlClass'))
            {
     ...
     * @uses HslOnnelaClassMap::classMap()
     * @uses HslOnnelaWsdlClass::getDefaultWsdlOptions()
     * @uses HslOnnelaWsdlClass::getSoapClientClassName()
     * @uses HslOnnelaWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('HslOnnelaClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = HslOnnelaClassMap::classMap();
     ...
     * If a class is named as {HslOnnela}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('HslOnnelaSoapClient') && is_subclass_of('HslOnnelaSoapClient','SoapClient'))
            return 'HslOnnelaSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses HslOnnelaWsdlClass::WSDL_CACHE_WSDL
     * @uses HslOnnelaWsdlClass::WSDL_COMPRESSION
     * @uses HslOnnelaWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses HslOnnelaWsdlClass::WSDL_ENCODING
     * @uses HslOnnelaWsdlClass::WSDL_EXCEPTIONS
     * @uses HslOnnelaWsdlClass::WSDL_FEATURES
     * @uses HslOnnelaWsdlClass::WSDL_LOGIN
     * @uses HslOnnelaWsdlClass::WSDL_PASSWORD
     * @uses HslOnnelaWsdlClass::WSDL_SOAP_VERSION
     * @uses HslOnnelaWsdlClass::WSDL_STREAM_CONTEXT
     * @uses HslOnnelaWsdlClass::WSDL_TRACE
     * @uses HslOnnelaWsdlClass::WSDL_TYPEMAP
     * @uses HslOnnelaWsdlClass::WSDL_URL
     * @uses HslOnnelaWsdlClass::VALUE_WSDL_URL
     * @uses HslOnnelaWsdlClass::WSDL_USER_AGENT
     * @uses HslOnnelaWsdlClass::WSDL_PROXY_HOST
     * @uses HslOnnelaWsdlClass::WSDL_PROXY_PORT
     * @uses HslOnnelaWsdlClass::WSDL_PROXY_LOGIN
     * @uses HslOnnelaWsdlClass::WSDL_PROXY_PASSWORD
     * @uses HslOnnelaWsdlClass::WSDL_LOCAL_CERT
     * @uses HslOnnelaWsdlClass::WSDL_PASSPHRASE
     * @uses HslOnnelaWsdlClass::WSDL_AUTHENTICATION
     * @uses HslOnnelaWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses HslOnnelaWsdlClass::getSoapClient()
     * @uses HslOnnelaWsdlClass::getFormatedXml()
     ...
     * @uses HslOnnelaWsdlClass::getSoapClient()
     * @uses HslOnnelaWsdlClass::convertStringHeadersToArray()
     ...
     * @uses HslOnnelaWsdlClass::getInternArrayToIterate()
     * @uses HslOnnelaWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses HslOnnelaWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses HslOnnelaWsdlClass::getInternArrayToIterateOffset()
     * @uses HslOnnelaWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses HslOnnelaWsdlClass::getInternArrayToIterateOffset()
     * @uses HslOnnelaWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see HslOnnelaWsdlClass::offsetGet()
     * @uses HslOnnelaWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses HslOnnelaWsdlClass::getAttributeName()
     * @uses HslOnnelaWsdlClass::__toString()
     * @uses HslOnnelaWsdlClass::_set()
     * @uses HslOnnelaWsdlClass::_get()
     * @uses HslOnnelaWsdlClass::setInternArrayToIterate()
     * @uses HslOnnelaWsdlClass::setInternArrayToIterateIsArray()
     * @uses HslOnnelaWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses HslOnnelaWsdlClass::item()
     * @uses HslOnnelaWsdlClass::length()
     * @return mixed
     */
